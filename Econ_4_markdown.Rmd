---
title: "ESM 204 - HW 4"
author: "Janelle Christiansan, Michael Wells & Rachel Rhodes"
date: "5/25/2020"
...
2 (A) As shown in Table 1, the present value utility over 200 years with moderate climate change (T = 4.4) is `r npv_pv_u_4.4` compared to the present value utility with no climate change (T = 0) which is `r npv_pv_u_0`.
